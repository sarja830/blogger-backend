...
const CommentContainer = () => {
    let {blog: {id, title, comments: {results: commentArr}, activity: {total_parent_comments}},commentsWrapper, setCommentsWrapper,totalParentComentsLoaded, setTotalCommentsLoaded, setBlog, blog} = useContext(BlogContext)

    const loadMoreComment = async( ) =>{
        let newCommentArr = await fetchComment({skip: totalParentComentsLoaded, blog_id: id, setParentCommentCountFun:setTotalCommentsLoaded, comment_array: commentArr })
